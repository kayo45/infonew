...
Route::prefix('admin')->group(function() {
  ...
  Route::get('/slider/datatables', 'Admin\SliderController@datatables')->name('admin-sldr-datatables');
  Route::get('/slider', 'Admin\SliderController@index')->name('admin-sldr-index');
  Route::get('/slider/create', 'Admin\SliderController@create')->name('admin-sldr-create');
  Route::get('/slider/edit/{id}', 'Admin\SliderController@edit')->name('admin-sldr-edit');
  Route::post('/slider/create', 'Admin\SliderController@store')->name('admin-sldr-store');
  Route::post('/slider/edit/{id}', 'Admin\SliderController@update')->name('admin-sldr-update');
  Route::get('/slider/delete/{id}', 'Admin\SliderController@destroy')->name('admin-sldr-delete');
